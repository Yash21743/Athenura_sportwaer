    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .reg-header.visible { opacity: 1; transform: translateX(0); }
        ...
        .reg-field-label.focused { color: rgba(23, 184, 147, 0.7); }
        ...
        .reg-toggle-vis.active { color: #17B893; }
      ...
      <div className="reg-shell">
        ...
        <div style={{ position: "absolute", inset: 0, pointerEvents: "none", overflow: "hidden", zIndex: 0 }}>
          <div className="reg-blob-1" style={{
            position: "absolute", top: "-120px", left: "8%",
            width: "420px", height: "420px", borderRadius: "50%",
            background: "radial-gradient(circle, rgba(23, 184, 147, 0.10) 0%, transparent 72%)",
            filter: "blur(50px)",
          }} />
          <div className="reg-blob-2" style={{
            position: "absolute", bottom: "-140px", right: "6%",
            width: "460px", height: "460px", borderRadius: "50%",
            background: "radial-gradient(circle, rgba(11, 122, 99, 0.35) 0%, transparent 78%)",
            filter: "blur(60px)",
          }} />
          <svg width="100%" height="100%" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice" style={{ position: "absolute", inset: 0, opacity: 0.06 }}>
        ...
        <div className={`reg-card ${pageIn ? "active" : ""}`}>
          ...
          <div className="reg-inner">
            ...
            <div className={`reg-header ${pageIn ? "visible" : ""}`}>
              ...
              <div>
                <div className="reg-eyebrow">Initial Setup</div>
                <div className="reg-brand-name">COMFY SPORTSWEAR</div>
              </div>
            </div>
